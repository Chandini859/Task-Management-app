...
const Navbar = () => {
  ...
  return (
    <>
      <header className='flex justify-between sticky top-0 p-4 bg-blue-500 text-white shadow-sm items-center'> {/* Apply blue background and white text */}
        ...
        <ul className='hidden md:flex gap-4 uppercase font-medium'>
          {authState.isLoggedIn ? (
            <>
              <li className="bg-gray-500 text-white hover:bg-gray-600 font-medium rounded-md">
